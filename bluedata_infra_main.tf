...
variable "hcpdomain" { default = "internal.cloudapp.net" }
...
output "jumphost_ssh_command" {
  value = "ssh -o StrictHostKeyChecking=no -i ${pathexpand(var.ssh_pub_key_path)} ${var.user}@${data.azurerm_public_ip.jumphost_ip.ip_address}"
}
